...
import { conclusion, experiment, lense, overview } from "../icons";
...
const Option = ({name} : {name: OptionName}) => {
  ...
  return (
    <div className='flex items-center ml-5 text-[1.2rem] rounded-xl hover:bg-[#1d1d1d] w-[80%] py-2 px-2 active:bg-[#1a1a1a] hover:cursor-pointer' onClick={() => {
        setOpt(name);
        window.scrollTo(0, 0);
        }}> 
